 ...
 <div id="index">
	...
	<div id="container">
		<p>O saldo da sua carteira é: <b>{{ formatPrice(650) }}</b></p>
		<nav id="botoes">
	...
	<tr id="titulo-tabela">
      ...
      <tr class="dados-tabela" v-for="transacaot of depositos" :key="transacaot.id">
...
export default {
  ...
  mounted() {
    api.get('/transacoes?tipo=Deposito').then(reponse => {
      this.depositos = reponse.data;
    });
  }
}
